...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("Mᴏᴠɪᴇ Gʀᴏᴜᴘ 🎬", url="https://t.me/MB_REQUEST") 
            ],[
            InlineKeyboardButton("Hᴇʟᴩ 🕸️", callback_data="help"),
            InlineKeyboardButton("Aʙᴏᴜᴛ ✨", callback_data="about")
            ],[
            InlineKeyboardButton("Cʜᴀɴɴᴇʟ 🔈", url="https://t.me/SIVAORIGINALS") 
        ]]
        m = await message.reply_sticker("CAACAgUAAxkBAAIIp2dO5u3H6Pim1GGjuyKc-nctJ0etAAIOFAACgXl5VsNedKiuLfRqHgQ") 
        await asyncio.sleep(2)
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton("Mᴏᴠɪᴇ Gʀᴏᴜᴘ 🎬", url="https://MB_REQUEST")
            InlineKeyboardButton("Cʜᴀɴɴᴇʟ 🔈", url="https://t.me/SIVAORIGINALS")
            ],[      
            InlineKeyboardButton("Hᴇʟᴩ 🕸️", callback_data="help"),
            InlineKeyboardButton("Aʙᴏᴜᴛ ✨", callback_data="about")
